        ...
        public static Dictionary<string, Category> Categories
        {
            get
            {
                if (categories == null)
                {
                    ...
                    {
                        new Category { CategoryName = "Men", Description="All men Perfumes" },
                        new Category { CategoryName = "Women", Description="All women perfumes" }
                    };
